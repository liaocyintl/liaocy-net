"use strict";
(self["webpackChunkliaocy_net"] = self["webpackChunkliaocy_net"] || []).push([[9817],{
...
function filterItems(items){return items.filter(function(item){if(item.type==='category'){return!!(0,docsUtils/* findFirstCategoryLink */.Wl)(item);}return true;});}function DocCardList(_ref){var items=_ref.items,className=_ref.className;return/*#__PURE__*/react.createElement("section",{className:(0,clsx_m/* default */.Z)('row',className)},filterItems(items).map(function(item,index){return/*#__PURE__*/react.createElement("article",{key:index,className:"col col--6 margin-bottom--lg"},/*#__PURE__*/react.createElement(DocCard,{key:index,item:item}));}));}
...
// extracted by mini-css-extract-plugin
/* harmony default export */ var DocCategoryGeneratedIndexPage_styles_module = ({"generatedIndexPage":"generatedIndexPage_vN6x","list":"list_eTzJ","title":"title_kItE"});
